...
$sql = "SELECT * FROM form WHERE meetingDate >= CURDATE()"; // Fetch current and future feedback
...
<head>
    ...
    <title>Workshop Feedback - GRAVITON</title>
...
<body>
    ...
    <div class="container mt-5">
        <div class="header">
            ...
            <a href="feedbackform.php" class="report">
                <button><i class='bx bx-plus'></i><span> Create Workshop Feedback</span></button>
            </a>
        </div>
